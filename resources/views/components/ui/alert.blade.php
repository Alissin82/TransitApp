...
{{-- Alert component: displays success, error, warning, or info messages --}}
@props([
    'variant' => 'info',
    'title' => '',
    'message' => '',
...
{{-- Alert container with variant-specific border and background --}}
