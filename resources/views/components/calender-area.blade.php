...
<div>
    ...
    <div class="fixed inset-0 items-center justify-center hidden p-5 overflow-y-auto modal z-99999" id="eventModal">
        ...
        <div class="modal-dialog relative flex w-full max-w-175 flex-col overflow-y-auto rounded-3xl bg-white p-6 lg:p-11 dark:bg-gray-900">
            ...
            <!-- Close Button -->
            <button class="modal-close-btn transition-color absolute top-5 end-5 z-999 flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 text-gray-400 hover:bg-gray-200 hover:text-gray-600 sm:h-11 sm:w-11 dark:bg-white/[0.05] dark:text-gray-400 dark:hover:bg-white/[0.07] dark:hover:text-gray-300">
            ...
            <div class="flex flex-col px-2 overflow-y-auto modal-content custom-scrollbar">
                ...
                <div class="modal-header">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        {{ __('Plan your next big moment: schedule or edit an event to stay on track') }}
                    </p>
                </div>
                ...
                <div class="mt-8 modal-body">
                                ...
                                <div class="form-check form-check-danger form-check-inline">
                                    <label class="flex items-center text-sm text-gray-700 form-check-label dark:text-gray-400" for="modalDanger">
                                        <span class="relative">
                                            ...
                                            <span class="flex items-center justify-center w-5 h-5 me-2 border border-gray-300 rounded-full box dark:border-gray-700">
                                            </span>
                                        </span>
                                        {{ __('Danger') }}
                                    </label>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="relative">
                            ...
                            <span class="absolute top-1/2 end-3.5 -translate-y-1/2 pointer-events-none">
